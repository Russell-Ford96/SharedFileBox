...
// var request = app.textRequest('WELCOME', {      //<Your text query>
    ...
    socket.on('new_apiai_messge', (message) => {
      ...
      if(message == 'WELCOME'){
        ...
        request.on('response', function(response) {
            ...
            io2.emit('new_apiai_messge',response.result.fulfillment.speech);
        });
        ...
        var request = app.textRequest(message, {      //<Your text query>
          sessionId: '12112017'                        //<unique session id>
        });
        request.on('response', function(response) {
