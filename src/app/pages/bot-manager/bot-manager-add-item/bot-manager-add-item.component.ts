...
@Component({
  selector: 'vr-bot-manager-add-item',
  templateUrl: './bot-manager-add-item.component.html',
  styleUrls: ['./bot-manager-add-item.component.scss'],
  animations: [...ROUTE_TRANSITION],
  host: { '[@routeTransition]': '' }
})
export class BotManagerAddItemComponent implements OnInit {
