...
@Component({
  selector: 'vr-bot-manager-statistics',
  templateUrl: './bot-manager-statistics.component.html',
  styleUrls: ['./bot-manager-statistics.component.scss'],
  animations: [...ROUTE_TRANSITION],
  host: { '[@routeTransition]': '' }
})           
export class BotManagerStatisticsComponent implements OnInit {
